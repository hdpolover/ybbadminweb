...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2021 at 04:55 PM
...
INSERT INTO `meal_type` (`id_meal_type`, `description`) VALUES
(1, 'Breakfast'),
(2, 'Breakfast');
...
ALTER TABLE `meal_attendance`
  ...
  ADD KEY `id_summit_day` (`id_summit_day`);
...
--
ALTER TABLE `meal_type`
  MODIFY `id_meal_type` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `meal_attendance`
  ...
  ADD CONSTRAINT `meal_attendance_ibfk_2` FOREIGN KEY (`id_summit_day`) REFERENCES `summits` (`id_summit`),
  ADD CONSTRAINT `meal_attendance_ibfk_3` FOREIGN KEY (`id_meal_type`) REFERENCES `meal_type` (`id_meal_type`),
  ADD CONSTRAINT `meal_attendance_ibfk_4` FOREIGN KEY (`id_summit_day`) REFERENCES `summit_days` (`id_summit_day`);
